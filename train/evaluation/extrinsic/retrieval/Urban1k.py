...
image_root = '' # TODO: change the path
caption_root = '' # TODO: change the path
...
class local_dataset(data.Dataset):
    def __init__(self):
        ...
        model, preprocess = longclip.load("", device='cuda') # TODO: change the path
    def __len__(self):
...
if __name__ == '__main__':
    ...
    model, preprocess = longclip.load("", device=device) # TODO: change the path
    model.eval()
    print("model done!")
